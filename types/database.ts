  ...
  public: {
    Tables: {
      ...
      organisation_security_settings: {
        Row: { id: string; organisation_id: string; admin_pin_hash: string | null; pin_hash: string | null; development_pin: string | null; recovery_code_hashes: Json; recovery_email: string | null; two_step_enabled: boolean; owner_password_verification_enabled: boolean; protect_client_archive: boolean; protect_staff_changes: boolean; protect_appointments: boolean; protect_services: boolean; protect_financials: boolean; protect_settings: boolean; pin_updated_at: string | null; pin_reset_requested_at: string | null; pin_reset_token_hash: string | null; pin_reset_token_expires_at: string | null; created_at: string; updated_at: string };
        Insert: { id?: string; organisation_id: string; admin_pin_hash?: string | null; pin_hash?: string | null; development_pin?: string | null; recovery_code_hashes?: Json; recovery_email?: string | null; two_step_enabled?: boolean; owner_password_verification_enabled?: boolean; protect_client_archive?: boolean; protect_staff_changes?: boolean; protect_appointments?: boolean; protect_services?: boolean; protect_financials?: boolean; protect_settings?: boolean; pin_updated_at?: string | null; pin_reset_requested_at?: string | null; pin_reset_token_hash?: string | null; pin_reset_token_expires_at?: string | null; created_at?: string; updated_at?: string };
        Update: { id?: string; organisation_id?: string; admin_pin_hash?: string | null; pin_hash?: string | null; development_pin?: string | null; recovery_code_hashes?: Json; recovery_email?: string | null; two_step_enabled?: boolean; owner_password_verification_enabled?: boolean; protect_client_archive?: boolean; protect_staff_changes?: boolean; protect_appointments?: boolean; protect_services?: boolean; protect_financials?: boolean; protect_settings?: boolean; pin_updated_at?: string | null; pin_reset_requested_at?: string | null; pin_reset_token_hash?: string | null; pin_reset_token_expires_at?: string | null; created_at?: string; updated_at?: string };
        Relationships: [];
      };
      treatment_plans: {
